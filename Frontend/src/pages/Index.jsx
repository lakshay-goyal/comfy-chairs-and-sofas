...
const Index = () => {
  ...
  const aboutSection = {
    title: "Our Story",
    description: "Balaji Seating Collection is the leading manufacturing of chairs andd office furniture in North India and is in one process of MANUFACTURING since 2007.",
    features: [
